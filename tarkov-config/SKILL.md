...
The active goal is stored in `memory/current-goal.json` and is intentionally local/untracked.
...
4. If the system appears near a known-good baseline but performance is at least 15% worse than expected, switch from graphics tuning to diagnostics:
