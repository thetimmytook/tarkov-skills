...
If hardware, resolution, map, and settings are close to a known good baseline but FPS is at least 15% worse than expected, stop normal graphics tuning and check:
