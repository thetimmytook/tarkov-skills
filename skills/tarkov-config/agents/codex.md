...
- If settings are missing or key names changed, continue with `unknown`, lower confidence; on script failure create a sanitized error report and offer the Crash form from `../references/configuration-rules.md`.
