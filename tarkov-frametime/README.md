...
PresentMon capture is blocking by design: the command waits until `-DurationSec` finishes. Use a short test capture first, then 90-180 seconds for real data.
